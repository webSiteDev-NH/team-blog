class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:account_update, keys: [:facility_name, :address, :phone_number, :start_time, :holiday_start_time, :holiday_close_time, :close_time, :access, :courts, :url, :facebook, :twitter, :instagram, :image])
  end
